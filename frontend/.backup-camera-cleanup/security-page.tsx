          ...
          <div className="mt-6">
            <div className="mb-4">
              ...
              <h3 className="mt-1 text-xl font-semibold text-white">
                Local Webcam Development Test
              </h3>

              <p className="mt-1 max-w-2xl text-sm text-slate-400">
                This development test uses the computer&apos;s built-in webcam.
                It is separate from the production CCTV streaming layer and
                does not identify the webcam as a permanent security camera.
              </p>
            </div>
            ...
            {onlineCameras.length > 0 ? (
              ...
              <div className="rounded-xl border border-slate-800 bg-slate-950 p-6 text-center">
                ...
                <p className="mt-2 text-xs text-slate-500">
                  Connect or bring a camera online to start live monitoring.
                </p>
              </div>
            )}
          </div>
